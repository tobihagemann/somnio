...
import { bootTestServer, joinFreshPlayer, makeDatabaseDependencies, sleep, startDatabase } from './support/harness.ts';
...
describe('world clock persistence', () => {
  ...
  it('persists across a service restart', async () => {
    ...
    const service = new WorldClockService(dependencies.worldRouter, worldClocks, await worldClocks.load(), testLogger());
