...
describe('render', () => {
  it.each([
    ...
    [
      { tag: 'worldClock', payload: '1;2;3;04;05;06' },
      'It is the year 1, the month 2, the day 3 and the time is 04:05:06.',
    ],
  ...
  it('renders the German world clock with positional placeholders', () => {
    expect(render({ tag: 'worldClock', payload: '1;2;3;04;05;06' }, 'de')).toBe(
      'Wir schreiben das Jahr 1, den Monat 2, den Tag 3 und es ist 04:05:06 Uhr.'
    )
  })
