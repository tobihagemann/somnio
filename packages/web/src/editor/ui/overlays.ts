...
export type EditorOverlayKind = 'gameMenu' | 'newMap' | 'sectorSettings' | 'about' | 'preferences' | 'sectorPicker' | 'saveAs';
  ...
  constructor(callbacks: EditorOverlayCallbacks, floorMaterialIDs: readonly string[]) {
    ...
    const saveAs = element('div', {
      children: [
        ...
        element('div', {
          className: 'form-actions',
          children: [button('Cancel', () => callbacks.onShowOverlay('gameMenu')), button('Save', saveAsCommit)],
        }),
      ],
    });
