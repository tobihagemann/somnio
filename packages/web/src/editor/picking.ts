 ...
 */
export function floorPixelAtScreen(camera: THREE.OrthographicCamera, viewport: ViewportSize, screen: ScreenPoint): { x: number; y: number } {
...
export function screenAtFloorPixel(camera: THREE.OrthographicCamera, viewport: ViewportSize, pixel: { x: number; y: number }): ScreenPoint {
