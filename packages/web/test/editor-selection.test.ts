...
import { isValidSelection, removeAllSelections, selectionBounds, selectionsEqual, toggleSelection } from '@/editor/selection';
...
describe('pick ordering', () => {
  it('prefers spawns over rects and the latest record within a kind', () => {
    const overlap: Sector = {
      ...populatedSector(),
      objects: [{ x: 0, y: 0, modelID: 'door', sourceWidth: 256, sourceHeight: 256, priority: 0, rotation: 0 }],
      collisionMasks: [
