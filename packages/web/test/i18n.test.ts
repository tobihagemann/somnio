 ...
 * the no-Unicode-ellipsis rule — and nothing forces a newly rendered string *into* that allowlist,
 * so a key the author forgets to add would ship unguarded. The source scan at the bottom closes
...
describe('catalog coverage', () => {
   ...
   * value for either of these would ship the literal key to every English player. Every other
   * rendered key is its own English text.
   */
  it.each([
