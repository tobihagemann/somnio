...
struct RoundTripTests {
    ...
    @Test func `enter sector`() throws {
        let sector = WireSector(
            ...
            ground: WireGroundTile(tilesetIndex: 0, sourceX: 0, sourceY: 0),
            light: WireLightSetting(indoor: false, brightness: 100),
            objects: [WireObject(x: 1, y: 2, tilesetIndex: 0, sourceX: 0, sourceY: 0, sourceWidth: 1, sourceHeight: 1, priority: 0)],
    ...
    @Test func `enter sector with NPCs and monster spawns`() throws {
        ...
        let sector = WireSector(
            ...
            ground: WireGroundTile(tilesetIndex: 1, sourceX: 2, sourceY: 3),
