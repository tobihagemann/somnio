...
/// stores the file's authored `spawnOrigin` verbatim and an authoring tool can render at the
/// box origin (preserving round-trip fidelity). Server gameplay-loop code calls this helper
