...
- Synthetic movement keys reach the game only after a mouse click into the 3D world view makes it first responder — right after an automated login, focus still sits on the OK button and held keys are silently ignored (0 movement, no error).
