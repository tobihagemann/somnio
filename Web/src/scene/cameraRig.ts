 ...
 * metres vertically. This is settled in-repo — `OrthographicCameraRig.swift` records that the
 * orthographic `scale` is the vertical world half-extent; treating it as full height made every
 * unprojection overshoot the drawn geometry by exactly 2x from the view centre, measured
 * against the live render, and the editor's picking math depends on it.
 *
